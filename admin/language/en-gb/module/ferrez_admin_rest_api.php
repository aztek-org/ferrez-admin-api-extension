...
$_['text_product_image_upload'] = 'Product image upload';
$_['text_product_image_upload_hint'] = 'Use multipart/form-data with image_file for POST /api/admin/v1/product and PUT /api/admin/v1/product/{product_id}.';
