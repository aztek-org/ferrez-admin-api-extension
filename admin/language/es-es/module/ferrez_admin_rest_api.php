<?php
$_['heading_title'] = 'API REST Admin Ferrez';

$_['text_extension'] = 'Extensiones';
$_['text_success'] = 'Éxito: Has modificado la configuración de la API REST Admin Ferrez.';
$_['text_edit'] = 'Editar API REST Admin Ferrez';
